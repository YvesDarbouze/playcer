        ...
        <div>
            <header className="relative bg-secondary text-foreground py-20 md:py-32 text-center overflow-hidden">
                <div className="absolute inset-0">
                     <video
                        src="/videos/5_the_open_202508150826.mp4"
                        autoPlay
                        loop
                        muted
                        playsInline
                ...
                <div className="container mx-auto relative">
                    <h1 className="text-5xl md:text-7xl font-headline font-black uppercase tracking-tighter">Stop Arguing. Start Winning.</h1>
