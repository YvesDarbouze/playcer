    ...
    <main className="container mx-auto p-4 md:p-8 max-w-4xl">
      <div className="prose prose-invert">
        ...
        <p className="font-bold">
          ...
          THEY AFFECT YOUR LEGAL RIGHTS AND OBLIGATIONS AND INCLUDE A BINDING
          ARBITRATION CLAUSE AND A WAIVER OF CLASS ACTION RIGHTS.
        </p>

        <p>
          Welcome to Playcer! These Terms of Service (&quot;Terms&quot;) govern
          your access to and use of the Playcer website, mobile applications,
          and all related services (collectively, the &quot;Service&quot;). The
          Service is owned and operated by Playcer Inc. (&quot;Playcer,&quot;
          &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;).
        </p>

        <p>
          By accessing or using the Service, registering for an account, or
          clicking &quot;I Agree,&quot; you are entering into a legally binding
          agreement with us and agree to be bound by these Terms and our
          Privacy Policy, which is incorporated herein by reference.
        </p>

        <p>
          IF YOU DO NOT AGREE TO ALL OF THESE TERMS, DO NOT ACCESS OR USE THE
          SERVICE.
        </p>
        ...
        <p>
          ...
          sportsbook. Our Service provides a marketplace where users can bet
          directly against one another (&quot;back&quot; or &quot;lay&quot; an
          outcome) on various sporting events. Playcer facilitates these wagers
        ...
        <p>
          ...
          guarantee that any wager you propose will be matched. Unmatched
        ...
        <p>
          ...
          skill-based contests and sports wagering is lawfully permitted. You
          agree that you will not access the Service from any jurisdiction
          where it is illegal to do so. We employ geo-fencing and other
        ...
        <p>
          ...
          Federal law, including the Wire Act of 1961 and the Unlawful Internet
          Gambling Enforcement Act of 2006 (UIGEA), as well as state laws,
          govern sports wagering. [6, 7, 8] Accessing the Service is void where
          prohibited by law.
        </p>
        ...
        <p>
          ...
          verify your registration information. This may include asking you for
          further information, requiring you to provide a government-issued ID,
        ...
        <p>
          ...
          facilitates your wager. The exact commission rate will be clearly
        ...
        <p>
          ...
          [11] We are not responsible for errors or inaccuracies in the data
          provided by this third party. Once an event is settled, winnings
        ...
        <p>
          ...
          or if an event is settled incorrectly, we reserve the right to void
        ...
        <ul>
          <li>
            Using automated means (bots, scrapers, spiders) to access the
            Service or collect data. [10]
          </li>
          <li>
            Engaging in any fraudulent activity, including collusion, money
            laundering, or using stolen payment methods.
          </li>
          <li>
            Tampering with the software, security, or administration of the
            Service. [10]
          </li>
          <li>
            Using the Service for any commercial purpose or for the benefit of a
            third party. [13]
          </li>
        ...
        <p>
          ...
          and images) are the exclusive property of Playcer and its licensors
        ...
        <p>
          ...
          FOR LOSS OF PROFITS, DATA, OR GOODWILL, ARISING OUT OF OR IN
        ...
        <p>
          ...
          binding arbitration, except that each party retains the right to seek
