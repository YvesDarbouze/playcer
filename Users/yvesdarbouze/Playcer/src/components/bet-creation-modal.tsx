    ...
    try {
      ...
      if (result.data.success) {
        ...
        toast({
          ...
          description: "Your tweet is ready to be sent.",
        });
        
        if (betPayload.recipientTwitterHandle) {
            const betUrl = `${window.location.origin}/bet/${result.data.betId}`;
            const tweetText = encodeURIComponent(`I challenge ${betPayload.recipientTwitterHandle} to a bet on Playcer! ${game.away_team} @ ${game.home_team}`);
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        />
                         <FormField
                            ...
                            render={({ field }) => (
                            <FormItem>
                                <FormLabel>Opponent's Twitter</FormLabel>
                                <FormControl>
